...
class ComponentOptions(var title: Nullable<String>?, var stack: StackConfig?, var tab: TabConfig?, var modalPresentationStyle: ModalPresentationStyle?, var bar: BarConfig?) {
